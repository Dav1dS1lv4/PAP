            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">AMD Ryzen Threadripper 3970X</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€760,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/processador.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>AMD Ryzen Threadripper 3970X</b><br>
                                    <b> 
                                       <h3>
                                          O AMD Ryzen Threadripper 3970X é um processador de alto desempenho, com 32 núcleos e 64 threads. Baseado na arquitetura Zen 2 da AMD, possui frequência base de 3,7 GHz e pode atingir 4,5 GHz em boost. Com 144MB de cache e suporte a PCIe 4.0, oferece um desempenho excepcional para tarefas multi-threaded e single-threaded. É recomendado para aplicações que exigem poder de processamento intenso, como renderização 3D e edição de vídeo profissional. Requer uma solução de resfriamento eficiente devido ao seu TDP de 280W.</h3>
                              </div>
                              </div>
