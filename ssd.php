            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">SSD Kingston A400 480Gb</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€18,60</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/ssd.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>SSD Kingston A400 480Gb</b><br>
                                    <b> 
                                       <h3>O SSD Kingston A400 está disponível com capacidade de 480GB. Essa capacidade oferece um espaço de armazenamento significativo para instalar o sistema operacional, aplicativos e armazenar arquivos pessoais.O SSD Kingston A400 utiliza a interface SATA III (SATA 6 Gb/s), que é uma interface comum em PCs e laptops. Isso significa que ele é compatível com a maioria dos dispositivos que possuem uma conexão SATA.</h3>
                              </div>
                              </div>
