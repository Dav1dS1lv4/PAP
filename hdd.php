            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">SEAGATE 4TB BARRACUDA</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€70,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/hd.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>SEAGATE 4TB BARRACUDA</b><br>
                                    <b> 
                                       <h3>O Seagate Barracuda de 4TB é um disco rígido de alta capacidade projetado para armazenamento de dados em computadores desktop e sistemas de armazenamento. Com uma capacidade de 4 terabytes, velocidade de rotação de 7200 RPM e interface SATA III, oferece uma combinação de armazenamento amplo, desempenho sólido e conexão rápida. Com um cache de dados de 256MB, é capaz de acelerar o acesso a arquivos frequentemente utilizados. É um disco rígido durável e confiável, adequado para uso geral em computadores domésticos e escritórios.</h3>
                              </div>
                              </div>
