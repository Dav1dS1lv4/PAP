            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">M65 RGB Ultra Wireless</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€60,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Perifericos/mouse-m65.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>Rato Gaming Corsair M65 RGB Ultra Wireless (26000 dpi - Preto)</b><br>
                                    <b> 
                                       <h3>Faça valer todos os seus cliques com o mouse para jogos CORSAIR M65 RGB ULTRA WIRELESS ajustável, com uma estrutura de alumínio durável, SLIPSTREAM WIRELESS hiper-rápido e um sensor óptico MARKSMAN de 26.000 DPI.</h3>
                              </div>
                              </div>
                              ...
                              <div class="row text-center">
                                  <div class="col-md-4">
                                    ...
                                    <p style="color:black;" >
                                     Marca | Corsair <br>
                                     Modelo | M65 RGB Ultra Wireless</p>
