            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">AX1600i Digital ATX</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€560,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/fonte.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>AX1600i Digital ATX</b><br>
                                    <b> 
                                       <h3>A Corsair AX1600i Digital ATX é uma fonte de alimentação de alta performance, com uma potência de 1600 watts e eficiência energética certificada 80 Plus Titanium. Possui um design totalmente modular para facilitar a instalação e o gerenciamento dos cabos. Com controle digital, permite ajustes em tempo real da voltagem e velocidade do ventilador. Possui tecnologia de resfriamento eficiente e recursos de proteção avançados. A fonte de alimentação é ideal para sistemas de computador exigentes e oferece uma garantia de longo prazo.</h3>
                              </div>
                              </div>
