            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">Rog Maximus Z690 Extreme Glacial</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€1200,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/motherboard.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>Rog Maximus Z690 Extreme Glacial</b><br>
                                    <b> 
                                       <h3>A placa-mãe ASUS ROG Maximus Z690 Extreme Glacial é uma placa-mãe de alto desempenho projetada para processadores Intel de 12ª geração. Ela possui recursos avançados como suporte a PCIe 5.0, memória DDR5, conectividade USB 4.0 e um sistema de resfriamento eficiente. Com vários slots de expansão, oferece a possibilidade de montar um sistema poderoso com várias placas gráficas e SSDs NVMe de alta velocidade. Além disso, possui conectividade Wi-Fi 6E, áudio de alta qualidade e recursos adicionais como iluminação RGB personalizável e suporte a overclocking. A placa-mãe é voltada para entusiastas e usuários avançados em busca de desempenho e recursos avançados.</h3>
                              </div>
                              </div>
