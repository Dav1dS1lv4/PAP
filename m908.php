            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">M908 Impact RGB</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€60,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Perifericos/reddragon-mouse.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>M908 Impact RGB</b><br>
                                    <b> 
                                       <h3>O M908 Impact RGB é um mouse para jogos produzido pela marca Redragon. Ele oferece recursos e desempenho voltados para jogadores exigentes. </h3>
                              </div>
                              </div>
                              ...
                              <div class="row text-center">
                                  <div class="col-md-4">
                                    ...
                                    <p style="color:black;" >
                                     Marca | Redragon <br>
                                     Modelo | M908 Impact </p>
                                       
                                  </div>
                                  <div class="col-md-4">
                                      
                                      <h4 class="my-3">Características Específicas</h4>
                                      <p style="color:black">Rato Ergonómico | Sim <br>
                                       DPI | 100 a 12400 <br>
                                       Wireless | Não <br>
                                    </p>
