            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">One360 Preto Liquid Cpu Cooling</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€75,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/water-cooler.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>One360 Preto Liquid Cpu Cooling</b><br>
                                    <b> 
                                       <h3>O One360 Preto Liquid CPU Cooling é um sistema de resfriamento líquido de CPU eficiente e compacto. Com um radiador de alta capacidade e ventoinhas de alta pressão estática, oferece um excelente desempenho de resfriamento para a CPU. Possui uma bomba de qualidade, tubos duráveis e flexíveis, além de iluminação RGB integrada para personalização estética. Com controle de velocidade da ventoinha e compatibilidade com vários sockets de CPU, o One360 Preto é uma escolha confiável para usuários que desejam um sistema de resfriamento líquido eficiente e com estilo.</h3>
                              </div>
                              </div>
