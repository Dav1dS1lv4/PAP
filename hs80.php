            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">HS80 RGB WIRELESS Premium Gaming</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€60,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Perifericos/corsair-headset.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>Headset Corsair HS80 RGB Wireless</b><br>
                                    <b> 
                                       <h3>De um sussurro quase inaudível a um som estrondoso, um par de drivers de áudio de neodímio de alta densidade de 50mm personalizados captam cada som com detalhes requintados, com uma faixa de frequência expandida de 20Hz a 40.000Hz.</h3>
                              </div>
                              </div>

                              <div class="row text-center" style="border-spacing: 20px;">
                                  <div class="col-md-4 custom-col">
                                    
                                    <h4 class="my-3">Referências</h4>
                                    <p style="color:black;" >
                                     Marca | Corsair <br>
                                     Modelo | HS80 RGB WIRELESS</p>
                                       
                                  </div>
                                  <div class="col-md-4 custom-col">
                                      
                                      <h4 class="my-3">Características Específicas</h4>
                                      <p style="color:black">Som surround 7.1 virtual: | Sim <br>
                                       Bateria de longa duração: | 20 Horas <br>
                                    </p>
