            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">Kingstone Fury Beast 16GB</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€45,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/ram.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>Kingstone Fury Beast (RAM)</b><br>
                                    <b> 
                                       <h3>
                                          A memória RAM Kingston Fury Beast é uma linha popular de módulos de memória para computadores. Elas estão disponíveis em várias capacidades e velocidades, oferecendo um desempenho rápido para o sistema. As memórias possuem um design elegante e podem vir com dissipadores de calor para melhorar a dissipação térmica. São compatíveis com placas-mãe DDR4 e suportam recursos de overclocking. A Kingston é uma marca confiável e oferece garantia para as memórias Fury Beast.</h3>
                              </div>
                              </div>
