            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">K70 PRO MINI Wireless</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€60,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Perifericos/teclado-corsair.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>K70 PRO MINI Wireless</b><br>
                                    <b> 
                                       <h3>Corsair K70 PRO MINI Wireless é um teclado mecânico compacto e sem fio projetado para jogadores que buscam um dispositivo de alto desempenho e portabilidade.</h3>
                              </div>
                              </div>
                              ...
                              <div class="row text-center">
                                  <div class="col-md-4">
                                    ...
                                    <p style="color:black;" >
                                     Marca | Corsair <br>
                                     Modelo | K70 PRO MINI Wireless</p>
                                       
                                  </div>
                                  <div class="col-md-4">
                                      
                                      <h4 class="my-3">Características Específicas</h4>
                                      <p style="color:black">Tamanho | 65% <br>
                                       Conexão sem fio | Sim <br>
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <p style="color:black">RGB Personalizável | Sim <br>
                                     Software de Personalização | Sim <br>
                                  </div>     
