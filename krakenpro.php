            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">Kraken Pro V2</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€50,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Perifericos/krakenprov2.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; font:bold;">Auscultadores Gaming com Fio RAZER Kraken (Over Ear - Multiplataforma - Noise Cancelling - Verde)</h3>
                              </div>
                              </div>
                              ...
                              <div class="row text-center">
                                  <div class="col-md-4">
                                      ...
                                      <p style="color:black;" >Referência | 6882293 <br>
                                       EAN | 6882293 <br>
                                       Marca | RAZER <br>
                                       Modelo | Kraken</p>
                                  ...
                                  <div class="col-md-4">
                                      ...
                                      <p style="color:black">  Tipologia | Over Ear <br>
                                       Compatibilidade | Multiplataforma <br>
                                       Frequência de Resposta (hz) | 12-28.000 <br>
                                       Impendância | 32ohm
                                       Sensibilidade | 109 <br>
                                       Diafragma | 50 <br>
                                       Dobrável | Não <br>
                                  ...
                                  <div class="col-md-4">
                                      ...
                                      <p style="color:black">Resolução ajustável | Sim <br>
                                       Fun | Microfone com botão mute.</p>
                                  </div>
