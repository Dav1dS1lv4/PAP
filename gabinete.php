            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                                 <h4 class="shirt_text">XXL E-Atx MARS GAMING Mcv3</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">€75,00</span></p>
                                 <div class="tshirt_img_solo"><img src="images/Pecas/gabinete.png" width="360" height="531.92">
                                 </div>
                           </div>
                           <div style="padding-top: 50px" class="col-md-8">
                              <div class="text-center">
                                  <h2 class="section-heading text-uppercase">Sobre</h2>
                                  <h3 style="color:black; text-align:left; font-size: 16px;"><b>XXL E-Atx MARS GAMING Mcv3</b><br>
                                    <b> 
                                       <h3>
                                          A caixa XXL E-ATX Mars Gaming MCV3 é um gabinete de computador espaçoso, projetado para acomodar placas-mãe E-ATX e oferecer suporte a componentes de alto desempenho. Com um design moderno e agressivo, apresenta painéis em vidro temperado e iluminação RGB personalizável. Possui bom gerenciamento de cabos, opções de refrigeração avançadas com suporte a sistemas líquidos e uma variedade de opções de armazenamento. Compatível com vários componentes e oferecendo conectividade conveniente, o MCV3 é ideal para usuários que desejam montar um sistema de computador potente, com bom fluxo de ar e visual atrativo.</h3>
                              </div>
                              </div>
                              </div>
