...
.cart_div span {
   ...
   <body>
                        ...
                        <ul>
                          	<!-- Cart -->
								...
								<?php
									...
									?>
									<div class="cart_div">
									<li><a href="carrinho.php"><img width="50px" heigth="50px" src="./images/cart.png" alt=""></li>
                           <span style="margin-top: 20px">
									...
									<?php
										...
										echo '<li><a href="carrinho.php"><img width="50px" heigth="50px" src="./images/cart.png"/></li>'; 
									}
									?>
								</div>
								<!-- /Cart -->
      ...
      <div class="fashion_section">
                  <div class="container">
                     <h1 class="fashion_taital">Peças</h1>
                     <div class="fashion_section_2">
                     <div class="row">
                     <?php 
                           $servername = "localhost:3307";
                           ...
                           die("Connection failed: " . $conn->connect_error);
                              ...
                              $sql = "SELECT * FROM produto where id_tipo=2 ";
                              $result = $conn->query($sql);
                        ...
                        <div class="col-lg-4 col-sm-4">
                           <a href="<?php echo $row['pagina']; ?>"> 
                              <div class="box_main">
                                 ...
                                 <p class="price_text">Preço  <span style="color: #262626;"><?php echo $row['preco']; ?>€</span></p>
                                 <div class="tshirt_img">
                                    <img src="images/Pecas/<?php echo $row['img']; ?>" width="300" height="531.92" class="cart-product-image"></img>
                                    </div>
                              </a>
                                 <div class="btn_main">
                                    <button onclick="location.href='index.php?id_prod=<?php echo $row['id_produto'];?>'" class="add-to-cart-btn" type="button"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="index.html"><img src="images/logoreal.png"></a></div>
